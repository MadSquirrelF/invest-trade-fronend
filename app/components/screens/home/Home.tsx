...
const Home: FC<IHome> = ({ slides, Adds, news }) => (
  <Meta
    ...
    description="Ваш партнер в оконном бизнесе!"
  >
    ...
    >
      <div className={styles.content}>
        ...
        <div className={styles.subTitle}>
          ...
          <h2>
            Поставщик оборудования и материалов для
            производства пластиковых и алюминиевых конструкций
            {` `}
          </h2>
        </div>
