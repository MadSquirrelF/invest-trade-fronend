...
const AddEdit: FC = () => {
  ...
  const { handleSubmit, register, formState: { errors }, setValue, getValues, control } = useForm<IAddEditInput>({
    mode: 'onChange'
  })
  ...
  return (
    <Meta title='Редактирование добавок'>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className={formStyles.form}>
            {isLoading ? <SkeletonLoader count={3} /> : <>
              <div className={formStyles.fields}>
                ...
                <Field type="number" {...register('price', {
