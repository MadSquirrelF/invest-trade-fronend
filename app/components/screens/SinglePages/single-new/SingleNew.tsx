...
const SingleNew: FC<{ item: INew }> = ({ item }) => {
  ...
  return (
    <Meta
      title={item.title}
      description={`Новость о ${item.title}`}
    >
        ...
        <div className={styles.wrapper}>
          ...
          <div className={styles.info}>
            <div className={styles.box}>
              ...
              >
                <path
                  d="M4.5 21C4.5 21 3 21 3 19.5C3 18 4.5
                   13.5 12 13.5C19.5 13.5 21 18 21 19.5C21 21 19.5
                    21 19.5 21H4.5ZM12 12C13.1935 12 14.3381 11.5259 15.182 10.682C16.0259 9.83807 16.5 8.69347 16.5 7.5C16.5 6.30653 16.0259
                   5.16193 15.182 4.31802C14.3381 3.47411
                   13.1935 3 12 3C10.8065 3 9.66193 3.47411 8.81802
                    4.31802C7.97411 5.16193 7.5 6.30653 7.5 7.5C7.5 8.69347 7.97411 9.83807 8.81802 10.682C9.66193 11.5259 10.8065 12 12 12Z"
                  fill="#0000FF"
                />
              </svg>
              <h2>{item.username}</h2>
